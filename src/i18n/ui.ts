...
export const ui = {
  en: {
    ...
    aboutMe: "About Me",
    experience:
      "+2 years of experience. Software Engineer and Content Creator on Programming from Bogotá, Colombia.",
    ...
    niceNailsDesc:
      "Manicure services website, including an online store developed using Astro, Svelte, Tailwind CSS, integrated with Mercadopago API.",
  ...
  es: {
    ...
    masterFinanceDesc:
      "Aplicación web y móvil centrada en mejorar las finanzas de los usuarios, desarrollada utilizando Next.js, Tailwind CSS y React Native.",
    niceNailsTitle: "Nice Nails - Landing Page y tienda online",
    niceNailsDesc:
      "Página web de servicios de manicura, incluyendo tienda online desarrollada usando Astro, Svelte, Tailwind CSS, integración con la API de Mercadopago.",
